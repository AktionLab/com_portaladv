...
<div id="PortalAdvMapViewTabs">
	...
	<div id="tab_normal" class="PortalAdvMapViewTabs_tab_active" onmouseover="if (this.className != 'PortalAdvMapViewTabs_tab_active') { this.className='PortalAdvMapViewTabs_tab_hover'; }" onmouseout="if (this.className != 'PortalAdvMapViewTabs_tab_active') { this.className='PortalAdvMapViewTabs_tab'; }" onclick="changeMapView('normal');">Map</div>
	...
	<div id="tab_hybrid" class="PortalAdvMapViewTabs_tab" onmouseover="if (this.className != 'PortalAdvMapViewTabs_tab_active') { this.className='PortalAdvMapViewTabs_tab_hover'; }" onmouseout="if (this.className != 'PortalAdvMapViewTabs_tab_active') { this.className='PortalAdvMapViewTabs_tab'; }" onclick="changeMapView('hybrid');">Hybrid</div>
