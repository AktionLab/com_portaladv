...
?>
							...
							if ($listing->{FIELDNAME_LISTING_VIRTUAL_TOUR_LINK}) {
								echo "<input type=\"button\" class=\"portaladv_button\" onmouseover=\"this.className='portaladv_button_hover';\" onmouseout=\"this.className='portaladv_button';\" onclick=\"return GB_showCenter('Beaver Creek Online Virtual Tour','" . $listing->{FIELDNAME_LISTING_VIRTUAL_TOUR_LINK} . "','600','800');\" value=\"" . BUTTON_VIRTUAL_TOUR . "\"></input>";
							}		
							?>
						</strong>
